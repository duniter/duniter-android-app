...
//            if(mSectionPosition.get(position).equals("bt")){
...
//
//        if(textQuery.length()!=0 && !autorisationFindNetwork) {
//            sectionPosition.put(contacts.size()+identities.size(), "bt");
//        }else if(textQuery.length()!=0 && autorisationFindNetwork) {
//            if (contacts.size()!=0) {
//                sectionPosition.put(0, mContext.getResources().getString(R.string.contact));
//            }
//            if (contacts.size()!=0 && identities.size()!=0) {
//                sectionPosition.put(contacts.size()+1,mContext.getResources().getString(R.string.network));
//            }
//            if (contacts.size()==0 && identities.size()!=0){
//                sectionPosition.put(0,mContext.getResources().getString(R.string.network));
//            }
//        }else if(textQuery.length()==0 && !autorisationFindNetwork) {
//            int position = 0;
//            String section = "";
...
//                String newSection;
//
//                if (contact.getAlias()!=null && contact.getAlias().length()!=0) {
//                    newSection = contact.getAlias().substring(0, 1).toUpperCase();
//                }else {
//                    newSection = contact.getUid().substring(0, 1).toUpperCase();
//                }
//
...
//                position++;
//            }
//        }else { // textQuery.length()==0 && autorisationFindNetwork
//
//        }
//
...
//            return identities.get(position-contacts.size());
//        }
//
