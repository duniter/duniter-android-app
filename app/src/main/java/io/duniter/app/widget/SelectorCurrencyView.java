...
import io.duniter.app.model.Entity.json.BlockchainParameterJson;
import io.duniter.app.model.Entity.Currency;
import io.duniter.app.model.Entity.Endpoint;
import io.duniter.app.model.Entity.json.NetworkPeeringJson;
import io.duniter.app.model.EntityWeb.BlockChainParameterWeb;
import io.duniter.app.model.EntityWeb.NetworkPeeringWeb;
...
public class SelectorCurrencyView {
    ...
    private void fetchBlockchainParameter(String address, int port, final NetworkPeeringJson peering) {
