package io.duniter.app.technical.crypto;
...
import io.duniter.app.technical.UCoinTechnicalException;

import static io.duniter.app.technical.crypto.CryptoUtils.checkLength;
import static io.duniter.app.technical.crypto.CryptoUtils.decodeUTF8;
import static io.duniter.app.technical.crypto.CryptoUtils.encodeBase64;
import static io.duniter.app.technical.crypto.CryptoUtils.isValid;
import static io.duniter.app.technical.crypto.CryptoUtils.prependZeros;
import static io.duniter.app.technical.crypto.CryptoUtils.slice;
import static io.duniter.app.technical.crypto.CryptoUtils.zeros;
