package io.duniter.app.view.dialog;
...
public class ConverterDialog extends DialogFragment{
    ...
    public static ConverterDialog newInstance(BigInteger _mUd, int _delay, EditText _mAmount, Spinner _spinner,String _name) {
        mUd = _mUd;
        delay = _delay;
        mAmount = _mAmount;
        mSpinner = _spinner;
