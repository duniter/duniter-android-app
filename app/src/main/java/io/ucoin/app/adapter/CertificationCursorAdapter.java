...
public class CertificationCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor data) {
        ...
        int dateIndex = data.getColumnIndex(SQLiteView.Certification.MEDIAN_TIME);
        int sigValidityIndex = data.getColumnIndex(SQLiteView.Certification.SIG_VALIDITY);
        int numberIndex = data.getColumnIndex(SQLiteView.Certification.NUMBER);
